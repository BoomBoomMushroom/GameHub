var recentActions = []
    ...
    function upa(){
        ...
        try {
            sendMsg('http://gameshub-api.herokuapp.com;/tokeninfo?token=' + getCookie("token") + ';GET');
            console.log("http://gameshub-api.herokuapp.com/tokeninfo?token="+getCookie("accToken"))
